...
RESORTS = [
    ...
    {'name': 'Eldora', 'state': 'CO', 'lat': 39.9372, 'lon': -105.5836,
     'acres': 680, 'vertical_ft': 1600, 'trails': 63, 'lifts': 10, 'snowfall_in': 300,
     'note': 'Closest major resort to Denver/Boulder'},
    {'name': 'Echo Mountain', 'state': 'CO', 'lat': 39.6731, 'lon': -105.6017,
     'acres': 226, 'vertical_ft': 600, 'trails': 22, 'lifts': 4, 'snowfall_in': 250},
    {'name': 'Howelsen Hill', 'state': 'CO', 'lat': 40.4842, 'lon': -106.8331,
     'acres': 65, 'vertical_ft': 440, 'trails': 17, 'lifts': 5, 'snowfall_in': 200,
     'note': 'Oldest continuously operating ski area in North America (1915)'},
    {'name': 'Ski Cooper', 'state': 'CO', 'lat': 39.4419, 'lon': -106.3197,
     'acres': 470, 'vertical_ft': 1200, 'trails': 60, 'lifts': 4, 'snowfall_in': 260},
    {'name': 'Monarch Mountain', 'state': 'CO', 'lat': 38.5114, 'lon': -106.3322,
     'acres': 800, 'vertical_ft': 1170, 'trails': 67, 'lifts': 7, 'snowfall_in': 350},
    {'name': 'Hesperus', 'state': 'CO', 'lat': 37.2914, 'lon': -108.0483,
     'acres': 60, 'vertical_ft': 700, 'trails': 26, 'lifts': 4, 'snowfall_in': 175},
    {'name': 'Silverton Mountain', 'state': 'CO', 'lat': 37.8364, 'lon': -107.6614,
     'acres': 1819, 'vertical_ft': 3087, 'trails': 69, 'lifts': 1, 'snowfall_in': 400,
     'note': 'Single chairlift, expert-only, mostly guided'},
    {'name': 'Kendall Mountain', 'state': 'CO', 'lat': 37.8064, 'lon': -107.6625,
     'acres': 75, 'vertical_ft': 240, 'trails': 8, 'lifts': 1, 'snowfall_in': 250},
    {'name': 'Granby Ranch', 'state': 'CO', 'lat': 40.0431, 'lon': -105.9425,
     'acres': 406, 'vertical_ft': 1000, 'trails': 41, 'lifts': 4, 'snowfall_in': 220},
    ...
    {'name': 'Eagle Point', 'state': 'UT', 'lat': 38.3211, 'lon': -112.3833,
     'acres': 650, 'vertical_ft': 1500, 'trails': 40, 'lifts': 5, 'snowfall_in': 400},
    {'name': 'Cherry Peak', 'state': 'UT', 'lat': 41.9719, 'lon': -111.7567,
     'acres': 240, 'vertical_ft': 1265, 'trails': 29, 'lifts': 3, 'snowfall_in': 250},
    {'name': 'Nordic Valley', 'state': 'UT', 'lat': 41.3119, 'lon': -111.8836,
     'acres': 90, 'vertical_ft': 1000, 'trails': 23, 'lifts': 4, 'snowfall_in': 350},
    ...
    {'name': 'White Pine', 'state': 'WY', 'lat': 42.7858, 'lon': -110.0744,
     'acres': 370, 'vertical_ft': 1100, 'trails': 25, 'lifts': 3, 'snowfall_in': 250},
    {'name': 'Hogadon Basin', 'state': 'WY', 'lat': 42.7517, 'lon': -106.3403,
     'acres': 80, 'vertical_ft': 600, 'trails': 27, 'lifts': 2, 'snowfall_in': 165},
    ...
    {'name': 'Showdown Montana', 'state': 'MT', 'lat': 46.8367, 'lon': -110.8961,
     'acres': 640, 'vertical_ft': 1400, 'trails': 36, 'lifts': 4, 'snowfall_in': 240},
    {'name': 'Great Divide', 'state': 'MT', 'lat': 46.7861, 'lon': -112.2589,
     'acres': 1600, 'vertical_ft': 1500, 'trails': 140, 'lifts': 6, 'snowfall_in': 150},
    {'name': 'Maverick Mountain', 'state': 'MT', 'lat': 45.3417, 'lon': -113.2375,
     'acres': 230, 'vertical_ft': 2020, 'trails': 24, 'lifts': 2, 'snowfall_in': 180},
    {'name': 'Teton Pass Ski Resort', 'state': 'MT', 'lat': 47.9908, 'lon': -112.7642,
     'acres': 350, 'vertical_ft': 1010, 'trails': 31, 'lifts': 2, 'snowfall_in': 300},
    ...
    {'name': 'Lookout Pass', 'state': 'ID', 'lat': 47.4575, 'lon': -115.6953,
     'acres': 540, 'vertical_ft': 1150, 'trails': 34, 'lifts': 4, 'snowfall_in': 400,
     'note': 'On ID/MT border'},
    {'name': 'Soldier Mountain', 'state': 'ID', 'lat': 43.5944, 'lon': -114.7872,
     'acres': 1147, 'vertical_ft': 1425, 'trails': 36, 'lifts': 3, 'snowfall_in': 250},
    {'name': 'Magic Mountain (ID)', 'state': 'ID', 'lat': 42.1850, 'lon': -114.2553,
     'acres': 120, 'vertical_ft': 700, 'trails': 14, 'lifts': 2, 'snowfall_in': 175},
    {'name': 'Kelly Canyon', 'state': 'ID', 'lat': 43.7944, 'lon': -111.6997,
     'acres': 740, 'vertical_ft': 1000, 'trails': 26, 'lifts': 4, 'snowfall_in': 200},
    ...
    {'name': 'Red River', 'state': 'NM', 'lat': 36.7100, 'lon': -105.4067,
     'acres': 290, 'vertical_ft': 1600, 'trails': 67, 'lifts': 8, 'snowfall_in': 214},
    {'name': 'Pajarito Mountain', 'state': 'NM', 'lat': 35.8919, 'lon': -106.3792,
     'acres': 750, 'vertical_ft': 1410, 'trails': 44, 'lifts': 5, 'snowfall_in': 150},
    {'name': 'Sipapu', 'state': 'NM', 'lat': 36.0306, 'lon': -105.4456,
     'acres': 200, 'vertical_ft': 1055, 'trails': 41, 'lifts': 4, 'snowfall_in': 190},

    # Arizona
    {'name': 'Arizona Snowbowl', 'state': 'AZ', 'lat': 35.3306, 'lon': -111.7106,
     'acres': 777, 'vertical_ft': 2300, 'trails': 55, 'lifts': 8, 'snowfall_in': 260},
    {'name': 'Sunrise Park Resort', 'state': 'AZ', 'lat': 33.9836, 'lon': -109.5572,
     'acres': 1200, 'vertical_ft': 1800, 'trails': 65, 'lifts': 10, 'snowfall_in': 250,
     'note': 'Owned by White Mountain Apache Tribe'},
    ...
    {'name': 'Tahoe Donner', 'state': 'CA', 'lat': 39.3528, 'lon': -120.2903,
     'acres': 120, 'vertical_ft': 600, 'trails': 16, 'lifts': 4, 'snowfall_in': 350},
    {'name': 'Soda Springs', 'state': 'CA', 'lat': 39.3225, 'lon': -120.3833,
     'acres': 200, 'vertical_ft': 652, 'trails': 17, 'lifts': 5, 'snowfall_in': 425},
    {'name': 'Donner Ski Ranch', 'state': 'CA', 'lat': 39.3175, 'lon': -120.3325,
     'acres': 460, 'vertical_ft': 750, 'trails': 52, 'lifts': 8, 'snowfall_in': 425},
    {'name': 'Boreal', 'state': 'CA', 'lat': 39.3328, 'lon': -120.3494,
     'acres': 380, 'vertical_ft': 500, 'trails': 41, 'lifts': 8, 'snowfall_in': 400},
    {'name': 'Mt. Shasta Ski Park', 'state': 'CA', 'lat': 41.3214, 'lon': -122.2056,
     'acres': 425, 'vertical_ft': 1435, 'trails': 32, 'lifts': 6, 'snowfall_in': 275},
    {'name': 'Mountain High', 'state': 'CA', 'lat': 34.3789, 'lon': -117.6736,
     'acres': 290, 'vertical_ft': 1600, 'trails': 59, 'lifts': 14, 'snowfall_in': 100,
     'note': 'Closest major resort to Los Angeles'},
    {'name': 'Snow Valley', 'state': 'CA', 'lat': 34.2253, 'lon': -117.0356,
     'acres': 240, 'vertical_ft': 1041, 'trails': 35, 'lifts': 12, 'snowfall_in': 90},
    {'name': 'Bear Mountain', 'state': 'CA', 'lat': 34.2331, 'lon': -116.8606,
     'acres': 198, 'vertical_ft': 1665, 'trails': 30, 'lifts': 11, 'snowfall_in': 100,
     'note': 'Big Bear area; Southern California'},
    {'name': 'Snow Summit', 'state': 'CA', 'lat': 34.2331, 'lon': -116.8911,
     'acres': 240, 'vertical_ft': 1209, 'trails': 32, 'lifts': 13, 'snowfall_in': 100,
     'note': 'Big Bear area; Southern California'},
    ...
    {'name': 'Lee Canyon', 'state': 'NV', 'lat': 36.3061, 'lon': -115.6736,
     'acres': 195, 'vertical_ft': 860, 'trails': 30, 'lifts': 4, 'snowfall_in': 175,
     'note': 'Closest major resort to Las Vegas'},
    ...
    {'name': 'Hoodoo', 'state': 'OR', 'lat': 44.4042, 'lon': -121.8694,
     'acres': 806, 'vertical_ft': 1035, 'trails': 36, 'lifts': 5, 'snowfall_in': 350},
    {'name': 'Anthony Lakes', 'state': 'OR', 'lat': 44.9647, 'lon': -118.2306,
     'acres': 1100, 'vertical_ft': 900, 'trails': 21, 'lifts': 3, 'snowfall_in': 300},
    {'name': 'Cooper Spur', 'state': 'OR', 'lat': 45.4172, 'lon': -121.6356,
     'acres': 50, 'vertical_ft': 350, 'trails': 10, 'lifts': 2, 'snowfall_in': 300},
    ...
    {'name': 'Bluewood', 'state': 'WA', 'lat': 46.0586, 'lon': -117.9142,
     'acres': 355, 'vertical_ft': 1125, 'trails': 24, 'lifts': 3, 'snowfall_in': 300},
    {'name': 'Mt. Spokane', 'state': 'WA', 'lat': 47.9244, 'lon': -117.1119,
     'acres': 1704, 'vertical_ft': 2065, 'trails': 52, 'lifts': 7, 'snowfall_in': 300},
    {'name': 'Summit at Snoqualmie', 'state': 'WA', 'lat': 47.4239, 'lon': -121.4133,
     'acres': 1981, 'vertical_ft': 2280, 'trails': 65, 'lifts': 22, 'snowfall_in': 428,
     'note': 'Combined Alpental + Summit West/Central/East'},

    # Alaska
    {'name': 'Alyeska', 'state': 'AK', 'lat': 60.9747, 'lon': -149.0997,
     'acres': 1610, 'vertical_ft': 2500, 'trails': 76, 'lifts': 9, 'snowfall_in': 669},
    {'name': 'Eaglecrest', 'state': 'AK', 'lat': 58.2497, 'lon': -134.5256,
     'acres': 640, 'vertical_ft': 1620, 'trails': 36, 'lifts': 4, 'snowfall_in': 350,
     'note': 'Juneau community ski area'},
    {'name': 'Hilltop Ski Area', 'state': 'AK', 'lat': 61.1378, 'lon': -149.7497,
     'acres': 30, 'vertical_ft': 294, 'trails': 9, 'lifts': 2, 'snowfall_in': 70,
     'note': 'Anchorage urban ski area'},
    ...
    {'name': 'Magic Mountain (VT)', 'state': 'VT', 'lat': 43.2233, 'lon': -72.8025,
     'acres': 205, 'vertical_ft': 1700, 'trails': 50, 'lifts': 4, 'snowfall_in': 145,
     'note': 'Independent, throwback to 1970s skiing; cult favorite'},
    {'name': 'Bromley', 'state': 'VT', 'lat': 43.2128, 'lon': -72.9425,
     'acres': 300, 'vertical_ft': 1334, 'trails': 47, 'lifts': 9, 'snowfall_in': 145},
    {'name': 'Burke', 'state': 'VT', 'lat': 44.5719, 'lon': -71.9114,
     'acres': 270, 'vertical_ft': 2011, 'trails': 50, 'lifts': 4, 'snowfall_in': 230,
     'note': 'Burke Mountain Academy, top US ski racing academy'},
    {'name': 'Bolton Valley', 'state': 'VT', 'lat': 44.4256, 'lon': -72.8675,
     'acres': 300, 'vertical_ft': 1704, 'trails': 71, 'lifts': 6, 'snowfall_in': 312},
    {'name': 'Middlebury Snow Bowl', 'state': 'VT', 'lat': 43.9636, 'lon': -73.0306,
     'acres': 110, 'vertical_ft': 1000, 'trails': 17, 'lifts': 3, 'snowfall_in': 200,
     'note': 'Owned by Middlebury College'},
    {'name': 'Suicide Six', 'state': 'VT', 'lat': 43.6358, 'lon': -72.5400,
     'acres': 100, 'vertical_ft': 650, 'trails': 24, 'lifts': 3, 'snowfall_in': 175,
     'note': 'Site of first US ski tow (1934)'},
    ...
    {'name': 'Cranmore', 'state': 'NH', 'lat': 44.0567, 'lon': -71.1142,
     'acres': 196, 'vertical_ft': 1200, 'trails': 56, 'lifts': 9, 'snowfall_in': 130},
    {'name': 'Mount Sunapee', 'state': 'NH', 'lat': 43.3261, 'lon': -72.0822,
     'acres': 233, 'vertical_ft': 1510, 'trails': 67, 'lifts': 10, 'snowfall_in': 130},
    {'name': "Pat's Peak", 'state': 'NH', 'lat': 43.1456, 'lon': -71.7939,
     'acres': 110, 'vertical_ft': 770, 'trails': 28, 'lifts': 11, 'snowfall_in': 100},
    {'name': 'Ragged Mountain', 'state': 'NH', 'lat': 43.4758, 'lon': -71.8050,
     'acres': 250, 'vertical_ft': 1250, 'trails': 57, 'lifts': 6, 'snowfall_in': 110},
    {'name': 'Crotched Mountain', 'state': 'NH', 'lat': 42.9711, 'lon': -71.8861,
     'acres': 100, 'vertical_ft': 875, 'trails': 23, 'lifts': 6, 'snowfall_in': 100},
    {'name': 'Dartmouth Skiway', 'state': 'NH', 'lat': 43.7536, 'lon': -72.0794,
     'acres': 104, 'vertical_ft': 968, 'trails': 30, 'lifts': 4, 'snowfall_in': 120,
     'note': 'Owned by Dartmouth College'},
    {'name': 'Black Mountain (NH)', 'state': 'NH', 'lat': 44.2300, 'lon': -71.1700,
     'acres': 140, 'vertical_ft': 1100, 'trails': 45, 'lifts': 5, 'snowfall_in': 125},
    {'name': 'King Pine', 'state': 'NH', 'lat': 43.8181, 'lon': -71.0286,
     'acres': 47, 'vertical_ft': 350, 'trails': 17, 'lifts': 4, 'snowfall_in': 100},
    ...
    {'name': 'Camden Snow Bowl', 'state': 'ME', 'lat': 44.2089, 'lon': -69.0997,
     'acres': 95, 'vertical_ft': 950, 'trails': 20, 'lifts': 4, 'snowfall_in': 100,
     'note': 'Coastal Maine, ocean views'},
    {'name': 'Mt. Abram', 'state': 'ME', 'lat': 44.3722, 'lon': -70.7664,
     'acres': 170, 'vertical_ft': 1150, 'trails': 44, 'lifts': 5, 'snowfall_in': 175},
    ...
    {'name': 'Holiday Valley', 'state': 'NY', 'lat': 42.2553, 'lon': -78.6539,
     'acres': 290, 'vertical_ft': 750, 'trails': 60, 'lifts': 13, 'snowfall_in': 180,
     'note': 'Largest ski area in Western NY; lake-effect snowbelt; ~500K visits/yr'},
    ...
    {'name': 'Plattekill', 'state': 'NY', 'lat': 42.2222, 'lon': -74.6831,
     'acres': 75, 'vertical_ft': 1100, 'trails': 38, 'lifts': 3, 'snowfall_in': 190,
     'note': 'Independent, weekends only, expert reputation'},
    {'name': 'Greek Peak', 'state': 'NY', 'lat': 42.5189, 'lon': -76.1097,
     'acres': 220, 'vertical_ft': 952, 'trails': 33, 'lifts': 8, 'snowfall_in': 120},
    {'name': 'Bristol Mountain', 'state': 'NY', 'lat': 42.7239, 'lon': -77.4222,
     'acres': 138, 'vertical_ft': 1200, 'trails': 38, 'lifts': 6, 'snowfall_in': 135,
     'note': 'Highest vertical between Rockies and Adirondacks'},
    {'name': 'Catamount', 'state': 'NY', 'lat': 42.2289, 'lon': -73.4711,
     'acres': 119, 'vertical_ft': 1000, 'trails': 36, 'lifts': 7, 'snowfall_in': 110,
     'note': 'On NY/MA border'},
    {'name': 'Holiday Mountain', 'state': 'NY', 'lat': 41.6736, 'lon': -74.6708,
     'acres': 50, 'vertical_ft': 400, 'trails': 17, 'lifts': 4, 'snowfall_in': 60},
    {'name': 'Song Mountain', 'state': 'NY', 'lat': 42.7825, 'lon': -76.0894,
     'acres': 120, 'vertical_ft': 700, 'trails': 25, 'lifts': 4, 'snowfall_in': 175},

    # Pennsylvania
    {'name': 'Blue Mountain', 'state': 'PA', 'lat': 40.7826, 'lon': -75.6261,
     'acres': 171, 'vertical_ft': 1082, 'trails': 40, 'lifts': 16, 'snowfall_in': 33,
     'note': "PA's highest vertical drop; ~75 mi NW of Philadelphia; ~300K visits/yr; 100% snowmaking"},
    {'name': 'Camelback', 'state': 'PA', 'lat': 41.0539, 'lon': -75.3447,
     'acres': 166, 'vertical_ft': 800, 'trails': 39, 'lifts': 16, 'snowfall_in': 50,
     'note': "Largest in the Poconos; serves NYC + Philly day-trip market"},
    {'name': 'Shawnee Mountain', 'state': 'PA', 'lat': 41.0917, 'lon': -75.0931,
     'acres': 125, 'vertical_ft': 700, 'trails': 23, 'lifts': 10, 'snowfall_in': 50},
    {'name': 'Whitetail', 'state': 'PA', 'lat': 39.7544, 'lon': -77.6856,
     'acres': 120, 'vertical_ft': 935, 'trails': 23, 'lifts': 7, 'snowfall_in': 36,
     'note': 'Serves DC/Baltimore market'},
    {'name': 'Liberty Mountain', 'state': 'PA', 'lat': 39.7239, 'lon': -77.3164,
     'acres': 100, 'vertical_ft': 620, 'trails': 16, 'lifts': 8, 'snowfall_in': 36},
    {'name': 'Roundtop Mountain', 'state': 'PA', 'lat': 40.1167, 'lon': -76.8633,
     'acres': 105, 'vertical_ft': 600, 'trails': 21, 'lifts': 9, 'snowfall_in': 36},
    {'name': 'Bear Creek', 'state': 'PA', 'lat': 40.4506, 'lon': -75.6067,
     'acres': 87, 'vertical_ft': 510, 'trails': 21, 'lifts': 7, 'snowfall_in': 40},
    {'name': 'Seven Springs', 'state': 'PA', 'lat': 40.0233, 'lon': -79.2989,
     'acres': 285, 'vertical_ft': 750, 'trails': 33, 'lifts': 14, 'snowfall_in': 138,
     'note': 'Largest in western PA; serves Pittsburgh'},
    {'name': 'Hidden Valley (PA)', 'state': 'PA', 'lat': 40.0672, 'lon': -79.3358,
     'acres': 110, 'vertical_ft': 610, 'trails': 26, 'lifts': 8, 'snowfall_in': 130},
    {'name': 'Elk Mountain', 'state': 'PA', 'lat': 41.7264, 'lon': -75.5550,
     'acres': 185, 'vertical_ft': 1000, 'trails': 27, 'lifts': 6, 'snowfall_in': 120},

    # New Jersey
    {'name': 'Mountain Creek', 'state': 'NJ', 'lat': 41.1883, 'lon': -74.5400,
     'acres': 167, 'vertical_ft': 1040, 'trails': 46, 'lifts': 8, 'snowfall_in': 65,
     'note': 'Closest major resort to NYC; serves NYC metro area'},
    {'name': 'Campgaw Mountain', 'state': 'NJ', 'lat': 41.0739, 'lon': -74.1933,
     'acres': 30, 'vertical_ft': 270, 'trails': 8, 'lifts': 4, 'snowfall_in': 25},

    # Massachusetts
    {'name': 'Wachusett', 'state': 'MA', 'lat': 42.4925, 'lon': -71.8853,
     'acres': 110, 'vertical_ft': 1000, 'trails': 27, 'lifts': 9, 'snowfall_in': 80},
    {'name': 'Berkshire East', 'state': 'MA', 'lat': 42.6597, 'lon': -72.7508,
     'acres': 200, 'vertical_ft': 1180, 'trails': 47, 'lifts': 7, 'snowfall_in': 140,
     'note': 'Powered by on-site solar + wind'},
    {'name': 'Jiminy Peak', 'state': 'MA', 'lat': 42.6608, 'lon': -73.2997,
     'acres': 167, 'vertical_ft': 1150, 'trails': 45, 'lifts': 9, 'snowfall_in': 150},

    # Connecticut
    {'name': 'Mohawk Mountain', 'state': 'CT', 'lat': 41.8075, 'lon': -73.2922,
     'acres': 112, 'vertical_ft': 650, 'trails': 26, 'lifts': 7, 'snowfall_in': 65,
     'note': 'First snowmaking ski resort in the world (1949)'},
    {'name': 'Mount Southington', 'state': 'CT', 'lat': 41.5933, 'lon': -72.9344,
     'acres': 51, 'vertical_ft': 425, 'trails': 14, 'lifts': 6, 'snowfall_in': 55},

    # === MIDWEST region ===
    # Minnesota
    {'name': 'Lutsen Mountains', 'state': 'MN', 'lat': 47.6642, 'lon': -90.7233,
     'acres': 1000, 'vertical_ft': 825, 'trails': 95, 'lifts': 8, 'snowfall_in': 110},
    {'name': 'Spirit Mountain', 'state': 'MN', 'lat': 46.7331, 'lon': -92.2347,
     'acres': 175, 'vertical_ft': 700, 'trails': 22, 'lifts': 9, 'snowfall_in': 80},
    {'name': 'Welch Village', 'state': 'MN', 'lat': 44.5450, 'lon': -92.7450,
     'acres': 140, 'vertical_ft': 360, 'trails': 60, 'lifts': 9, 'snowfall_in': 50},
    {'name': 'Buck Hill', 'state': 'MN', 'lat': 44.7158, 'lon': -93.2911,
     'acres': 49, 'vertical_ft': 309, 'trails': 16, 'lifts': 8, 'snowfall_in': 50,
     'note': 'Where Lindsey Vonn learned to ski'},
    {'name': 'Afton Alps', 'state': 'MN', 'lat': 44.8478, 'lon': -92.7878,
     'acres': 300, 'vertical_ft': 350, 'trails': 50, 'lifts': 18, 'snowfall_in': 50},
    # Wisconsin
    ...
    {'name': 'Cascade Mountain', 'state': 'WI', 'lat': 43.5894, 'lon': -89.4633,
     'acres': 176, 'vertical_ft': 460, 'trails': 47, 'lifts': 11, 'snowfall_in': 45},
    {'name': 'Trollhaugen', 'state': 'WI', 'lat': 45.3922, 'lon': -92.6244,
     'acres': 80, 'vertical_ft': 260, 'trails': 24, 'lifts': 11, 'snowfall_in': 50},
    {'name': 'Alpine Valley (WI)', 'state': 'WI', 'lat': 42.6675, 'lon': -88.3878,
     'acres': 90, 'vertical_ft': 388, 'trails': 20, 'lifts': 11, 'snowfall_in': 45},
    # Illinois
    {'name': 'Chestnut Mountain', 'state': 'IL', 'lat': 42.4456, 'lon': -90.3633,
     'acres': 220, 'vertical_ft': 475, 'trails': 19, 'lifts': 9, 'snowfall_in': 50},
    # Iowa
    {'name': 'Sundown Mountain', 'state': 'IA', 'lat': 42.5394, 'lon': -90.7906,
     'acres': 40, 'vertical_ft': 475, 'trails': 21, 'lifts': 5, 'snowfall_in': 35},
    # Michigan
    ...
    {'name': 'Pine Knob', 'state': 'MI', 'lat': 42.7178, 'lon': -83.2922,
     'acres': 70, 'vertical_ft': 305, 'trails': 17, 'lifts': 7, 'snowfall_in': 40},
    {'name': 'Caberfae Peaks', 'state': 'MI', 'lat': 44.2378, 'lon': -85.7536,
     'acres': 230, 'vertical_ft': 485, 'trails': 34, 'lifts': 7, 'snowfall_in': 130},
    {'name': 'Mt. Bohemia', 'state': 'MI', 'lat': 47.3778, 'lon': -88.0036,
     'acres': 585, 'vertical_ft': 900, 'trails': 100, 'lifts': 3, 'snowfall_in': 273,
     'note': 'Expert-only, Upper Peninsula; no grooming, ungroomed terrain'},
    # South Dakota
    ...
    {'name': 'Timberline Mountain', 'state': 'WV', 'lat': 39.0233, 'lon': -79.4842,
     'acres': 100, 'vertical_ft': 1000, 'trails': 39, 'lifts': 4, 'snowfall_in': 150},
    {'name': 'Canaan Valley', 'state': 'WV', 'lat': 39.0089, 'lon': -79.4458,
     'acres': 95, 'vertical_ft': 850, 'trails': 47, 'lifts': 4, 'snowfall_in': 180},
    ...
    {'name': 'App Ski Mountain', 'state': 'NC', 'lat': 36.1414, 'lon': -81.6939,
     'acres': 50, 'vertical_ft': 365, 'trails': 12, 'lifts': 4, 'snowfall_in': 60,
     'note': 'Appalachian Ski Mountain; near Boone NC'},
    ...
    {'name': 'Massanutten', 'state': 'VA', 'lat': 38.4278, 'lon': -78.7642,
     'acres': 70, 'vertical_ft': 1110, 'trails': 16, 'lifts': 6, 'snowfall_in': 35,
     'note': 'Largest in VA; serves DC market'},
    {'name': 'Wisp', 'state': 'MD', 'lat': 39.5497, 'lon': -79.3611,
     'acres': 132, 'vertical_ft': 700, 'trails': 34, 'lifts': 11, 'snowfall_in': 100,
     'note': "Maryland's only commercial ski resort"},
